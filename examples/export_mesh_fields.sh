#!/bin/bash
python3 export_grid_data_uniform.py --xf_project='../Test_Data/Test_Coil.xf' --export_file='test_grid.mat' --sim=1 --run=1 --origin='[0.0, 0.0, 0.0]' --lengths='[0.256, 0.256, 0.256]' --deltas='[0.002, 0.002, 0.002]'
